  ...
  return (
    <div className="w-20 md:w-72 h-screen fixed left-0 top-0 z-50 flex flex-col border-r border-white/5 bg-slate-950/60 backdrop-blur-2xl">
      ...
      <div className="flex-1 space-y-2 px-3">
        {[
          { id: AppMode.GENERAL, label: t(lang, 'navGeneral'), icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
